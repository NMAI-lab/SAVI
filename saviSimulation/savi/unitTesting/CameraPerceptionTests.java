...
class CameraPerceptionTests {
	...
	void test() {
		...
		Perception testCaseWithType = new CameraPerception(perceptionName, type, timeStamp, azumuth, elevation, range);
		...
		Perception similarTestCase = new CameraPerception(perceptionName, timeStamp, azumuth + 0.001, elevation, range);
