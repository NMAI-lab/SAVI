...
public class UaVBehavior extends UxVBehavior {
	 ...
	 */
	public UaVBehavior(String id, String type, PVector initialPosition, double reasoningCyclePeriod, double sensorsErrorProb, double sensorsErrorStdDev, double seed) {	
