...
package savi.agent.internalActions;
...
public class GetRelativePosition extends DefaultInternalAction {
	...
	public Object execute(TransitionSystem ts, Unifier un, Term[] args) throws Exception {
        ...
        ts.getAg().getLogger().info("executing internal action 'savi.agent.internalActions.absolutePosition'");
		...
		try {
			...
			PVector targetPosition = new PVector((float)targetPositionX.solve(), (float)targetPositionY.solve(), (float)targetPositionZ.solve());
			PVector refPosition = new PVector((float)refPositionX.solve(), (float)refPositionY.solve(), (float)refPositionZ.solve());
			List<Double> positionData = Geometry.relativePositionPolar(targetPosition, refPosition, (double)refAngle.solve());
		...
		// Deal with error cases
			...
			throw new JasonException("The internal action 'absolutePosition' received the wrong number of arguments.");
		}
		catch(ClassCastException e) {
			throw new JasonException("The internal action 'absolutePosition' received arguments that are of the wrong type.");
		}
		catch (Exception e) {
