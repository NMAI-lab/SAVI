...
public class UAS extends AgentModel {
    ...
    private static final Logger logger = Logger.getLogger(UAS.class.getName());
     ...
     */
    UAS(String id, String type, PShape shape, PVector initialPosition, double reasoningCyclePeriod) {
    ...
    public PShape getShape() {
        ...
        shape.rotate((float) ((float) getCompassAngle() + Math.PI / 2));
